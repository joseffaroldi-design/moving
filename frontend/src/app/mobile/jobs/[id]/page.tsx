          ...
          <Section title="Route">
            <div className="flex items-start gap-2 text-sm">
              ...
              <div>
                ...
                <p className="text-navy">{job.origin_address || "—"}</p>
              </div>
            </div>
            <div className="mt-2 flex items-start gap-2 text-sm">
              ...
              <div>
                ...
                <p className="text-navy">{job.destination_address || "—"}</p>
              </div>
            </div>
          </Section>
              ...
              <ul className="space-y-2">
                {job.crew.map((m) => (
                  <li key={m.profile_id} className="flex items-center gap-2 text-sm">
                    ...
                    <span className={m.is_me ? "font-semibold text-navy" : "text-slate-700"}>
                      {m.name || "Crew member"}
                      {m.is_me && " (You)"}
                    </span>
